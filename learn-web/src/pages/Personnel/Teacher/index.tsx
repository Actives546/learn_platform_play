...
const TeacherPage = () => {
  ...
  const [modalTitle, setModalTitle] = useState('新增老师')
  ...
  return (
    <div
      className="teacher-management-page"
      style={{
        display: 'flex',
      ...
      >
        <div style={{ padding: '8px 0' }}>
          <div style={{ marginBottom: 16, fontSize: 15, color: '#333' }}>
            确定要删除老师 <span style={{ color: '#ff4d4f', fontWeight: 600 }}>"{deletingUserName}"</span> 吗？
          </div>
